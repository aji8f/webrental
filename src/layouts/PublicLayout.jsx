                        ...
                        <Link to="/" className="flex items-center gap-3">
                            {settings?.logo ? (
                                <img
                                    ...
                                    alt={settings?.contact?.name || 'Logo'}
            ...
            <footer className="bg-surface-dark border-t border-border-dark pt-16 pb-8 mt-auto">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                        <div className="col-span-1 md:col-span-1">
                            ...
                            <p className="text-gray-400 text-sm leading-relaxed">
                                {settings?.hero?.subtitle || 'Spesialis penyewaan peralatan event support.'}
                            </p>
                        </div>
                        <div>
                    ...
                    <div className="border-t border-border-dark pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-500 text-sm">© {new Date().getFullYear()} {settings?.contact?.name || ''} All rights reserved.</p>
